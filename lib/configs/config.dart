...
class Colors {
  ...
  Color _mainDarkColor = Color(0xFF10163a);
  Color _secondColor = Color(0xFF04526B);
  Color _secondDarkColor = Color(0xFF005b69);
  Color _accentColor = Color(0xFFADC4C8);
  Color _accentDarkColor = Color(0xFFADC4C8);
  Color _successColor = Color(0xFF28C76F);
  Color _warningColor = Color(0xFFFF9F43);
  Color _dangerColor = Color(0xFFEA5455);
